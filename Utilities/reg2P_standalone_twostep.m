function [dreg,shifts]=reg2P_standalone_twostep(data,mimg,kriging,numBlocks,n_ch,whichch,maxregshift,fs)
...
[dreg,shifts_temp]=reg2P_standalone(data_orig,mimg,kriging,[1 1],n_ch,whichch,maxregshift(1),fs,false);
...
[dreg,ds]=reg2P_standalone(dreg,mimg,kriging,numBlocks,n_ch,whichch,maxregshift(2),fs,false);
    if nargout>1
        shifts={ds{1},ds_rigid,ds{2}};
    end
    % mimg=pad_expand(mimg,pad);
